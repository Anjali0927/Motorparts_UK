  ...
  <div className="container mx-auto p-4">
    ...
    <div className="flex flex-row flex-wrap justify-between basis-3/12">
      <form onSubmit={handleSubmit} className="mb-4 w-full lg:w-1/2 xl:w-1/3">
        ...
        <input type="text" name="industry" placeholder="Industry" value={formData.industry} onChange={handleChange} className="block mb-2 w-full p-2 border" />
        <input type="text" name="contact" placeholder="Contact" value={formData.contact} onChange={handleChange} className="block mb-2 w-full p-2 border" />
